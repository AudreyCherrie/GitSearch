...
export class UserComponent implements OnInit {
  ...
  repos =[];
  clone = [];
  username:string = "AudreyCherrie";
  viewRepo:boolean = false;

  ngOnInit() {
    this.searchUser("AudreyCherrie")
  }
  ...
  //     element.name.indexOf(toSearch) === 0 ? element.display = false : element.display = true;
  //   })
  //   $("#repoSearch").val("")
